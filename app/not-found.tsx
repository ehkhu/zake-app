...
export default function NotFoundPage() {
    ...
    <div className="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                <div className="-intro-x lg:mr-20">
                    <Image alt="zake" className="h-48 lg:h-auto" width={300} height={200} src="error-illustration.svg"/>
                </div>
                <div className="mt-10 lg:mt-0">
                    ...
                    <Button className="intro-x btn py-3 px-4 border-white dark:border-darkmode-400 dark:text-slate-200 mt-10"><Link href="/dashboard">Back to Home</Link></Button>
                </div>
            </div>
    </>)
}