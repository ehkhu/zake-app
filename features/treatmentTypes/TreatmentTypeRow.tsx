...
import { useDeleteTreatmentType } from "./useDeleteTreatmentType";
import { useToast } from "@/components/ui/use-toast";

export function TreatmentTypeRow({ treatmentType,selectedIds,onHandlecheck }: any) {
  ...
  const handleDelete = (treatmentTypeId:any)=>{
    deleteTreatmentType(treatmentTypeId,{onSuccess:()=>{
      //on succcess
    },
      ...
      <TableCell className="py-2">
        <Dialog>
          ...
          <DialogContent className="sm:max-w-md" style={{ maxWidth: 650 }}>
            <DialogHeader>
              <DialogTitle>Edit TreatmentType</DialogTitle>
            </DialogHeader>
            <div className="flex items-center space-x-2">
              <div className="grid flex-1 gap-2">
                <CreateTreatmentTypeForm treatmentTypeToEdit={treatmentType} />
              </div>
            </div>
          </DialogContent>
        </Dialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              treatmentType record and remove your data from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
