...
export function TreatmentRow({ treatment,selectedIds,onHandlecheck }: any) {
  ...
  return (
    <TableRow>
      ...
      <TableCell className="py-2">{treatment.patient.name}</TableCell>
      <TableCell className="py-2">{treatment.dentist.name}</TableCell>
      <TableCell className="py-2">{procedure_description}</TableCell>
      <TableCell className="py-2 font-bold">{total_cost}</TableCell>
      <TableCell className="py-2">
        <Dialog>
          <DropdownMenu>
