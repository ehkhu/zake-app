...
export function DentistRow({ dentist,selectedIds,onHandlecheck }: any) {
  ...
  const {deleteDentist,isDeleting} = useDeleteDentist();
  const handleDelete = (dentistId:any)=>{
    deleteDentist(dentistId,{onSuccess:()=>{
      //on succcess
    },
  ...
  // Array.from(dentistIds).includes(checkboxId)
  return (
    <TableRow>
      ...
      <TableCell className="py-2">{specialization}</TableCell>
      <TableCell className="py-2">
        <Dialog>
          <DropdownMenu>
          ...
          <DialogContent className="sm:max-w-md" style={{ maxWidth: 650 }}>
            ...
            <div className="flex items-center space-x-2">
              <div className="grid flex-1 gap-2">
                <CreateDentistForm dentistToEdit={dentist} />
              </div>
            </div>
          </DialogContent>
        </Dialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              dentist record and remove your data from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
